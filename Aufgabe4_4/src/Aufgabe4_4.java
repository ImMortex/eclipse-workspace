...
public class Aufgabe4_4 {
	public static void main(String[] args) throws IOException {
		...
		for (int z = 0; z <= teilstring.length() - 1; z++) {
			...
			if (asciiCodes[0][z] >= 65 && asciiCodes[0][z] <= 90) // wenn es ein Großbuchstabe ist
			{
				asciiCodes[0][z] = teilstring.codePointAt(z) + 32; // [0][z] für Kleinbuchstaben
				asciiCodes[1][z] = teilstring.codePointAt(z); // [1][z] für Großbuchstaben
			}
		...
		myFileReader = new FileReader("Text.txt");  //FileReader wieder neu geöffnet
